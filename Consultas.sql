...
--Consulta 18 Promedio de facturación diaria (utilizar rango de fechas) para conocer la tendencia de ingresos por dia.
...
--Consulta 29 Departamento con mejor rating de satisfaccion
SET @fecha_inicio = '2021-01-01';
SET @fecha_fin    = '2026-05-30';
...
--Consulta 30 Habitaciones ocupadas por mayor duracion de estancia clasificados por tipo de habitacion
SET @fecha_inicio = '2026-01-01';
